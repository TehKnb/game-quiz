...
function getResultContent(score: number): ResultContent {
  if (score <= 7) {
    return {
      type: "red",
      badge: "🔴 0–7 балів",
      badgeClassName: "bg-[#fdecec] text-[#d93025]",
  ...
  if (score <= 13) {
    return {
      type: "yellow",
      badge: "🟡 8–13 балів",
      badgeClassName: "bg-[#fff7db] text-[#8a6700]",
  ...
  return {
    type: "green",
    badge: "🟢 14–20 балів",
    badgeClassName: "bg-[#e8f7ec] text-[#219653]",
    ...
    <section className="rounded-[24px] bg-white px-4 py-6 sm:px-8 sm:py-8">
      <div className="mx-auto max-w-[760px]">
        ...
        <div className="mb-6 flex flex-wrap items-center gap-3">
          <div
            className={`inline-flex rounded-[12px] px-4 py-2 text-[16px] font-semibold ${result.badgeClassName}`}
          >
            {result.badge}
          </div>

          <div className="rounded-[12px] bg-[#f3f4f6] px-4 py-2 text-[16px] font-semibold text-[#374151]">
